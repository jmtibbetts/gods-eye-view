...
test('no unchanged Realtime tool definition drifts silently', () => {
  ...
  // the scanner, sdr and atc layers extend show_data_layers_menu's enum. All
  // other tool definitions retain their pin.
  assert.equal(digest, '1664b27ebd06b00c', 'an unchanged Realtime tool definition drifted');
});
