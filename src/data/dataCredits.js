...
export const DATA_CREDITS = [
  ...
  {
    key: 'rainviewer',
    html: 'Weather radar: <a href="https://www.rainviewer.com/api.html" target="_blank" rel="noopener noreferrer">RainViewer</a> (NEXRAD and global precipitation mosaics)',
  },
  {
    key: 'atc-directory',
