...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _scannerPanelSection: document.getElementById('scanner-panel'),
    _scannerLayerState: document.getElementById('scanner-layer-state'),
    _scannerEnableBtn: document.getElementById('scanner-enable-btn'),
    _scannerSearch: document.getElementById('scanner-search'),
    _scannerList: document.getElementById('scanner-list'),
    _scannerListCount: document.getElementById('scanner-list-count'),
    _scannerNowName: document.getElementById('scanner-now-name'),
    _scannerNowMeta: document.getElementById('scanner-now-meta'),
    _scannerNowCalls: document.getElementById('scanner-now-calls'),
    _scannerPauseBtn: document.getElementById('scanner-pause-btn'),
    _scannerStopBtn: document.getElementById('scanner-stop-btn'),
    _scannerFlyBtn: document.getElementById('scanner-fly-btn'),
    ...
    _sdrSearch: document.getElementById('sdr-search'),
    _sdrFreq: document.getElementById('sdr-freq'),
    _sdrMode: document.getElementById('sdr-mode'),
    _sdrList: document.getElementById('sdr-list'),
    _sdrListCount: document.getElementById('sdr-list-count'),
    _sdrNowName: document.getElementById('sdr-now-name'),
    _sdrNowMeta: document.getElementById('sdr-now-meta'),
    _sdrOpenBtn: document.getElementById('sdr-open-btn'),
    _sdrFlyBtn: document.getElementById('sdr-fly-btn'),
    _sdrClearBtn: document.getElementById('sdr-clear-btn'),
    _sdrPresets: document.getElementById('sdr-presets'),
    _sdrPresetHint: document.getElementById('sdr-preset-hint'),
    _sdrAdvancedBtn: document.getElementById('sdr-advanced-btn'),
    _sdrAdvanced: document.getElementById('sdr-advanced'),
    _sdrListenBtn: document.getElementById('sdr-listen-btn'),
    _atcPanelSection: document.getElementById('atc-panel'),
    _atcLayerState: document.getElementById('atc-layer-state'),
    _atcEnableBtn: document.getElementById('atc-enable-btn'),
    _atcSearch: document.getElementById('atc-search'),
    _atcToweredOnly: document.getElementById('atc-towered-only'),
    _atcList: document.getElementById('atc-list'),
    _atcListCount: document.getElementById('atc-list-count'),
    _atcNowName: document.getElementById('atc-now-name'),
    _atcNowMeta: document.getElementById('atc-now-meta'),
    _atcFreqs: document.getElementById('atc-freqs'),
    _atcListenBtn: document.getElementById('atc-listen-btn'),
    _atcFollowBtn: document.getElementById('atc-follow-btn'),
    _atcFlyBtn: document.getElementById('atc-fly-btn'),
    _atcStopBtn: document.getElementById('atc-stop-btn'),
    _atcFollowState: document.getElementById('atc-follow-state'),
    _atcFollowContact: document.getElementById('atc-follow-contact'),
    _atcFollowPhase: document.getElementById('atc-follow-phase'),
    _atcPlaybackState: document.getElementById('atc-playback-state'),
    _monitorPanelSection: document.getElementById('monitor-panel'),
    _monitorLayerState: document.getElementById('monitor-layer-state'),
    _monitorAddBtn: document.getElementById('monitor-add-btn'),
    _monitorRadius: document.getElementById('monitor-radius'),
    _monitorList: document.getElementById('monitor-list'),
    _monitorEmpty: document.getElementById('monitor-empty'),
    _monitorClearBtn: document.getElementById('monitor-clear-btn'),
    _watchlistPanelSection: document.getElementById('watchlist-panel'),
    _watchlistLayerState: document.getElementById('watchlist-layer-state'),
    _watchlistInput: document.getElementById('watchlist-input'),
    _watchlistAddBtn: document.getElementById('watchlist-add-btn'),
    _watchlistList: document.getElementById('watchlist-list'),
    _watchlistEmpty: document.getElementById('watchlist-empty'),
    _watchlistClearBtn: document.getElementById('watchlist-clear-btn'),
    _vesselWatchPanelSection: document.getElementById('vessel-watch-panel'),
    _vesselWatchLayerState: document.getElementById('vessel-watch-layer-state'),
    _vesselWatchList: document.getElementById('vessel-watch-list'),
    _vesselWatchEmpty: document.getElementById('vessel-watch-empty'),
    _vesselWatchNote: document.getElementById('vessel-watch-note'),
    _inspectPanelSection: document.getElementById('inspect-panel'),
    _inspectState: document.getElementById('inspect-state'),
    _inspectBody: document.getElementById('inspect-body'),
    _inspectEmpty: document.getElementById('inspect-empty'),
    _launchPanelSection: document.getElementById('launch-panel'),
    _launchLayerState: document.getElementById('launch-layer-state'),
    _launchBody: document.getElementById('launch-body'),
    _launchNote: document.getElementById('launch-note'),
    _sensorsPanelSection: document.getElementById('sensors-panel'),
    _sensorsLayerState: document.getElementById('sensors-layer-state'),
    _sensorsBody: document.getElementById('sensors-body'),
    _sensorsNote: document.getElementById('sensors-note'),
    _imageryPanelSection: document.getElementById('imagery-panel'),
    _imageryLayerState: document.getElementById('imagery-layer-state'),
    _imageryList: document.getElementById('imagery-list'),
    _imageryClearBtn: document.getElementById('imagery-clear-btn'),
    _imageryNote: document.getElementById('imagery-note'),
    _timelinePanelSection: document.getElementById('timeline-panel'),
    _timelineLayerState: document.getElementById('timeline-layer-state'),
    _timelineLabel: document.getElementById('timeline-label'),
    _timelineSlider: document.getElementById('timeline-slider'),
    _timelineBackBtn: document.getElementById('timeline-back-btn'),
    _timelinePlayBtn: document.getElementById('timeline-play-btn'),
    _timelineForwardBtn: document.getElementById('timeline-forward-btn'),
    _timelineLiveBtn: document.getElementById('timeline-live-btn'),
    _timelineNote: document.getElementById('timeline-note'),
    _snapshotBtn: document.getElementById('snapshot-btn'),
    _worldOverlayCanvas: document.getElementById('world-overlay-canvas'),
    _locationMiniCity: document.getElementById('location-mini-city'),
    _locationMiniPoi: document.getElementById('location-mini-poi'),
    _audioDockRoot: document.getElementById('audio-dock'),
    _audioDockBar: document.getElementById('audio-dock-bar'),
    _audioDockKind: document.getElementById('audio-dock-kind'),
    ...
    _sdrPlaybackState: document.getElementById('sdr-playback-state'),
