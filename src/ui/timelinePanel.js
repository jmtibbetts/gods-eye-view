...
export class TimelinePanel {
  ...
  togglePlay() {
    ...
    if (!layers.length) {
      this.onToast(
        'TIMELINE: turn on Satellite Imagery (VIIRS) — nothing enabled carries an archive',
      );
      return;
    }
    ...
    if (e.note) {
      ...
      setText(
        ...
        layers.length
          ...
          : 'Nothing enabled carries an archive. Turn on Satellite Imagery (VIIRS) to scrub back through it.',
      );
    }
  }
