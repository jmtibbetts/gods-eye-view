...
export class LayerBindings {
  ...
  get _scannerPanel() {
    return this.readControls()._scannerPanel;
  }
  get _sdrPanel() {
    return this.readControls()._sdrPanel;
  }
  get _atcPanel() {
    return this.readControls()._atcPanel;
  }
  get _monitorPanel() {
    return this.readControls()._monitorPanel;
  }

  get _watchlistPanel() {
    return this.readControls()._watchlistPanel;
  }
  ...
  get _imageryPanel() {
    return this.readControls()._imageryPanel;
  }
  get _sensorsPanel() {
  ...
  get _inspectPanel() {
    return this.readControls()._inspectPanel;
  }
  observeCamera() {
  ...
  attachDataManager(dataManager) {
    ...
    this._scannerPanel?.connect();
    this._sdrPanel?.connect();
    this._atcPanel?.connect();
