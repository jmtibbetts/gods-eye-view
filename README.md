...
Twenty-two layers and map sources. **Twenty have a keyless path.** Some offer additional capabilities with a provider key. (🟢 no key · 🟡 free key · 🔴 metered.)
...
| 🌀 **Weather & Sat Imagery** | Three tile overlays that stack under everything else: NEXRAD composite radar, GOES-East GeoColor, and VIIRS true-colour from the most recent pass — so live flights visibly fly around the storm they are actually diverting around                                                                                                                       | RainViewer + NASA GIBS                  | 🟢                                                                                                  |
