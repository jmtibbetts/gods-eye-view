...
| 📡 **SDR Receivers**        | 1,300+ public web SDRs — KiwiSDR, WebSDR, OpenWebRX and friends — with bands and antennas. Pick a band (Airband, Marine, Ham, Shortwave…) and press LISTEN: the nearest receiver that covers it opens in a window on the map, waterfall and all. Or click a receiver for its card and open it tuned to an exact frequency                                                       | receiverbook.de + curated lists         | 🟢                                                                                                  |
